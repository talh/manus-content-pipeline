...
class ManusAutomation:
    ...
    def perform_research(self, instruction: Dict) -> Dict:
        ...
        try:
            from manus_research_integrated import perform_comprehensive_research
    ...
    def format_research_report(self, results: Dict, instruction: Dict, 
        ...
        """Format research results into the specified report format"""
...
# Category: {instruction['category']}
# Category ID: {instruction['category_id']}
# Generated: {timestamp}
...
"""
        ...
        if results['cases']:
            for idx, case in enumerate(results['cases'], 1):
                report += f"""### Case {idx}: {case.get('title', 'Untitled')}
...
The research did not return any cases matching the criteria.
This may indicate that the research function needs to be implemented or refined.
